...
- Fixed Ctrl+N in a scoped agents view creating the new agent at the top level instead of under the agent whose children the view shows ([ENG-5106](https://linear.app/primeintellect/issue/ENG-5106/ctrln-in-agents-view-creates-agent-at-wrong-depth)).
