...
- Fixed resumed and concurrently repaired sessions losing entries when a crash left an incomplete JSONL tail, including immediate recovery from dead-writer locks ([#928](https://github.com/PrimeIntellect-ai/prime-agent/issues/928)).
