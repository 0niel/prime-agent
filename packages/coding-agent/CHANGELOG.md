...
- Changed subagent and refinement guidance to favor non-blocking subagent tasks by default and to capture reusable delegation roles, procedures, facts, preferences, and prompt addendums with `/refine`.
