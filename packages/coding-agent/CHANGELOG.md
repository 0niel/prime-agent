...
- Added conservative encoded-size, dimension, and pixel-count checks before app-controlled image decoding; native clipboard backends may decode before returning bytes.
