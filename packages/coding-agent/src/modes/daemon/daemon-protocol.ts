...
export const DAEMON_PERSISTED_LAUNCH_ENV_KEYS = [
	"HOME", "PATH", "TMPDIR", "TMP", "TEMP", "XDG_CACHE_HOME", "XDG_CONFIG_HOME", "XDG_DATA_HOME",
	"XDG_RUNTIME_DIR", "XDG_STATE_HOME", "TSX_TSCONFIG_PATH", ENV_AGENT_DIR, "PI_CODING_AGENT_DIR",
	"PI_OFFLINE", "PI_PACKAGE_DIR", "PI_SKIP_VERSION_CHECK", "DO_NOT_TRACK", "PRIME_AGENT_TELEMETRY",
	"PRIME_AGENT_TELEMETRY_ENDPOINT", "PRIME_AGENT_TRACES_BASE_URL", "PRIME_AGENT_DOWNLOAD_BASE_URL",
] as const;
